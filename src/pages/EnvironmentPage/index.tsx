    ...
    return(
        <>  
            ...
            <div id="page">
                <section id="hero" className="d-flex align-items-center section-half">
                    ...
                    <div className="row">
                        <div className="col-xl-6">
                            <h1>{content.environmentPage.title}</h1>
                            <h2 className="margin-bottom">{content.environmentPage.subtitle}</h2>
                            { content.environmentPage.button.map(function(item, index){
                                return(
                ...
                <Sections content={content.environmentPage.content} withMarginTop={false}/>
                <Footer/>
            </div>
        </>
    );
